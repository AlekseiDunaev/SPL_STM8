...
/**
  ...
  * @retval None
  */
#ifdef CLK_SLOWACTIVEHALTWAKEUPCMD
...
/**
  ...
  * @retval None
  */
#ifdef CLK_PERIPHERALCLOCKCONFIG
...
/**
  ...
  * @retval None
  */
#ifdef CLK_CLOCKSECURITYSYSTEMENABLE
...
/**
  ...
  * @retval None
  */
#ifdef CLK_ADJUSTHSICALIBRATIONVALUE
...
/**
  ...
  * @retval None
  */
#ifdef CLK_SYSCLKEMERGENCYCLEAR
